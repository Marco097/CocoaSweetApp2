  ...
  export default {
    ...
    if (producto) {
        ...
        async saveOrUpdate() {
            ...
            me.producto.hecho == '' ? me.productoErrors.hecho= true : me.productoErrors.hecho = false;
            me.producto.vencimiento == '' ? me.productoErrors.vencimiento = true : me.productoErrors.vencimiento = false;
            ...
            if (me.producto.nombre) {
                ...
                formData.append("hecho", me.producto.hecho);
                formData.append("vencimiento", me.producto.vencimiento);
